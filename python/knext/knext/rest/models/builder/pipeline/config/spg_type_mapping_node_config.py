...
class SpgTypeMappingNodeConfig(object):
    ...
    def __init__(self, type='SPG_TYPE_MAPPING', spg_type=None, mapping_filters=None, mapping_configs=None, subject_fusing_config=None, local_vars_configuration=None):  # noqa: E501
