...
class Test(BuilderJob):
    ...
    def build(self):
        source = CSVReader(
            ...
            columns=["id", "text", "integer", "float", "standard",
        ...
        event_mapping = (
            ...
            .add_property_mapping("concept", TEST.CenterEvent.conceptProperty, TEST.Concept1)
            .add_sub_property_mapping("confidence_concept", "confidence")
            .add_property_mapping("entity", TEST.CenterEvent.subject, TEST.Entity1)
            .add_relation_mapping("event", TEST.CenterEvent.eventRelation, TEST.CenterEvent)
        ...
        entity_mapping = (
            ...
            .add_relation_mapping("entity_relation", TEST.Entity1.entityRelation, TEST.Entity2)
        ...
        concept_mapping = (
            ...
            .add_relation_mapping("lead_to_concept2", TEST.Concept1.leadTo, TEST.Concept2)
            .add_relation_mapping("lead_to_concept3", TEST.Concept1.leadTo, TEST.Concept3)
        )
